...
/**
 * The base implementation of the facility external visitor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityExternalVisitorServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.FacilityExternalVisitorServiceImpl
 * @see com.pacnet.connect.service.FacilityExternalVisitorServiceUtil
 * @generated
 */
public abstract class FacilityExternalVisitorServiceBaseImpl
	extends BaseServiceImpl implements FacilityExternalVisitorService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityExternalVisitorServiceUtil} to access the facility external visitor remote service.
	 */
	...
	private FacilityExternalVisitorServiceClpInvoker _clpInvoker = new FacilityExternalVisitorServiceClpInvoker();
}