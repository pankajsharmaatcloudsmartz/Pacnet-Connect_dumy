...
/**
 * The base implementation of the facility remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.FacilityServiceImpl
 * @see com.pacnet.connect.service.FacilityServiceUtil
 * @generated
 */
public abstract class FacilityServiceBaseImpl extends BaseServiceImpl
	implements FacilityService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityServiceUtil} to access the facility remote service.
	 */
	...
	private FacilityServiceClpInvoker _clpInvoker = new FacilityServiceClpInvoker();
}