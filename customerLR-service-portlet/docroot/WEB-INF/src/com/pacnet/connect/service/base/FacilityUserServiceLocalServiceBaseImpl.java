...
/**
 * The base implementation of the facility user service local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityUserServiceLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class FacilityUserServiceLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FacilityUserServiceLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityUserServiceLocalServiceUtil} to access the facility user service local service.
	 */
	...
	public FacilityUserService addFacilityUserService(
		FacilityUserService facilityUserService) throws SystemException {
		facilityUserService.setNew(true);

		return facilityUserServicePersistence.update(facilityUserService, false);
	}
	 ...
	 */
	public FacilityUserService createFacilityUserService(long id) {
		return facilityUserServicePersistence.create(id);
	}
	...
	public FacilityUserService deleteFacilityUserService(long id)
		throws PortalException, SystemException {
		return facilityUserServicePersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FacilityUserService deleteFacilityUserService(
		FacilityUserService facilityUserService) throws SystemException {
		return facilityUserServicePersistence.remove(facilityUserService);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FacilityUserService.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return facilityUserServicePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilityUserServicePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FacilityUserService fetchFacilityUserService(long id)
		throws SystemException {
		return facilityUserServicePersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the facility user service with the primary key.
	 *
	 * @param id the primary key of the facility user service
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FacilityUserService getFacilityUserService(long id)
		throws PortalException, SystemException {
		return facilityUserServicePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return facilityUserServicePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacilityUserService> getFacilityUserServices(int start, int end)
		throws SystemException {
		return facilityUserServicePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFacilityUserServicesCount() throws SystemException {
		return facilityUserServicePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FacilityUserService updateFacilityUserService(
		FacilityUserService facilityUserService) throws SystemException {
		return updateFacilityUserService(facilityUserService, true);
	}
	...
	public FacilityUserService updateFacilityUserService(
		...
		return facilityUserServicePersistence.update(facilityUserService, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.FacilityUserService",
			facilityUserServiceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facilityUserServicePersistence.getDataSource();
	...
	private FacilityUserServiceLocalServiceClpInvoker _clpInvoker = new FacilityUserServiceLocalServiceClpInvoker();
}