...
/**
 * The base implementation of the access request facility service remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestFacilityServiceServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.AccessRequestFacilityServiceServiceImpl
 * @see com.pacnet.connect.service.AccessRequestFacilityServiceServiceUtil
 * @generated
 */
public abstract class AccessRequestFacilityServiceServiceBaseImpl
	extends BaseServiceImpl implements AccessRequestFacilityServiceService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestFacilityServiceServiceUtil} to access the access request facility service remote service.
	 */
	...
	private AccessRequestFacilityServiceServiceClpInvoker _clpInvoker = new AccessRequestFacilityServiceServiceClpInvoker();
}