...
/**
 * The base implementation of the access request status remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestStatusServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.AccessRequestStatusServiceImpl
 * @see com.pacnet.connect.service.AccessRequestStatusServiceUtil
 * @generated
 */
public abstract class AccessRequestStatusServiceBaseImpl extends BaseServiceImpl
	implements AccessRequestStatusService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestStatusServiceUtil} to access the access request status remote service.
	 */
	...
	private AccessRequestStatusServiceClpInvoker _clpInvoker = new AccessRequestStatusServiceClpInvoker();
}