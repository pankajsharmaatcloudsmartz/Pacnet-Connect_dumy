...
/**
 * The base implementation of the s m a email history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMAEmailHistoryLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMAEmailHistoryLocalServiceImpl
 * @see com.pacnet.connect.service.SMAEmailHistoryLocalServiceUtil
 * @generated
 */
public abstract class SMAEmailHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SMAEmailHistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMAEmailHistoryLocalServiceUtil} to access the s m a email history local service.
	 */

	/**
	 * Adds the s m a email history to the database. Also notifies the appropriate model listeners.
	 *
	 * @param smaEmailHistory the s m a email history
	 * @return the s m a email history that was added
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMAEmailHistory addSMAEmailHistory(SMAEmailHistory smaEmailHistory)
		throws SystemException {
		smaEmailHistory.setNew(true);

		return smaEmailHistoryPersistence.update(smaEmailHistory, false);
	}
	 ...
	 */
	public SMAEmailHistory createSMAEmailHistory(long id) {
		return smaEmailHistoryPersistence.create(id);
	}

	/**
	 * Deletes the s m a email history with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the s m a email history
	 * @return the s m a email history that was removed
	 * @throws PortalException if a s m a email history with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public SMAEmailHistory deleteSMAEmailHistory(long id)
		throws PortalException, SystemException {
		return smaEmailHistoryPersistence.remove(id);
	}

	/**
	 * Deletes the s m a email history from the database. Also notifies the appropriate model listeners.
	 *
	 * @param smaEmailHistory the s m a email history
	 * @return the s m a email history that was removed
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.DELETE)
	public SMAEmailHistory deleteSMAEmailHistory(
		SMAEmailHistory smaEmailHistory) throws SystemException {
		return smaEmailHistoryPersistence.remove(smaEmailHistory);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SMAEmailHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaEmailHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaEmailHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SMAEmailHistory fetchSMAEmailHistory(long id)
		throws SystemException {
		return smaEmailHistoryPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the s m a email history with the primary key.
	 *
	 * @param id the primary key of the s m a email history
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SMAEmailHistory getSMAEmailHistory(long id)
		throws PortalException, SystemException {
		return smaEmailHistoryPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return smaEmailHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SMAEmailHistory> getSMAEmailHistories(int start, int end)
		throws SystemException {
		return smaEmailHistoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSMAEmailHistoriesCount() throws SystemException {
		return smaEmailHistoryPersistence.countAll();
	}

	/**
	 * Updates the s m a email history in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param smaEmailHistory the s m a email history
	 * @return the s m a email history that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMAEmailHistory updateSMAEmailHistory(
		SMAEmailHistory smaEmailHistory) throws SystemException {
		return updateSMAEmailHistory(smaEmailHistory, true);
	}
	 ...
	 *
	 * @param smaEmailHistory the s m a email history
	 * @param merge whether to merge the s m a email history with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the s m a email history that was updated
	 * @throws SystemException if a system exception occurred
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMAEmailHistory updateSMAEmailHistory(
		SMAEmailHistory smaEmailHistory, boolean merge)
		throws SystemException {
		smaEmailHistory.setNew(false);

		return smaEmailHistoryPersistence.update(smaEmailHistory, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.SMAEmailHistory",
			smaEmailHistoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.pacnet.connect.model.SMAEmailHistory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = smaEmailHistoryPersistence.getDataSource();
	...
	private SMAEmailHistoryLocalServiceClpInvoker _clpInvoker = new SMAEmailHistoryLocalServiceClpInvoker();
}