...
/**
 * The base implementation of the access request note history local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestNoteHistoryLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class AccessRequestNoteHistoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccessRequestNoteHistoryLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestNoteHistoryLocalServiceUtil} to access the access request note history local service.
	 */
	...
	public AccessRequestNoteHistory addAccessRequestNoteHistory(
		AccessRequestNoteHistory accessRequestNoteHistory)
		throws SystemException {
		accessRequestNoteHistory.setNew(true);

		return accessRequestNoteHistoryPersistence.update(accessRequestNoteHistory,
			false);
	}
	 ...
	 */
	public AccessRequestNoteHistory createAccessRequestNoteHistory(long id) {
		return accessRequestNoteHistoryPersistence.create(id);
	}
	...
	public AccessRequestNoteHistory deleteAccessRequestNoteHistory(long id)
		throws PortalException, SystemException {
		return accessRequestNoteHistoryPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AccessRequestNoteHistory deleteAccessRequestNoteHistory(
		AccessRequestNoteHistory accessRequestNoteHistory)
		throws SystemException {
		return accessRequestNoteHistoryPersistence.remove(accessRequestNoteHistory);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AccessRequestNoteHistory.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessRequestNoteHistoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessRequestNoteHistoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AccessRequestNoteHistory fetchAccessRequestNoteHistory(long id)
		throws SystemException {
		return accessRequestNoteHistoryPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AccessRequestNoteHistory getAccessRequestNoteHistory(long id)
		throws PortalException, SystemException {
		return accessRequestNoteHistoryPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return accessRequestNoteHistoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AccessRequestNoteHistory> getAccessRequestNoteHistories(
		int start, int end) throws SystemException {
		return accessRequestNoteHistoryPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccessRequestNoteHistoriesCount() throws SystemException {
		return accessRequestNoteHistoryPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccessRequestNoteHistory updateAccessRequestNoteHistory(
		AccessRequestNoteHistory accessRequestNoteHistory)
		throws SystemException {
		return updateAccessRequestNoteHistory(accessRequestNoteHistory, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.AccessRequestNoteHistory",
			accessRequestNoteHistoryLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = accessRequestNoteHistoryPersistence.getDataSource();
	...
	private AccessRequestNoteHistoryLocalServiceClpInvoker _clpInvoker = new AccessRequestNoteHistoryLocalServiceClpInvoker();
}