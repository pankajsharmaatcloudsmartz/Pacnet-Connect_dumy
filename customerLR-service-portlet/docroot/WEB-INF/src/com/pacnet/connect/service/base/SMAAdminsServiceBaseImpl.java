...
/**
 * The base implementation of the s m a admins remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMAAdminsServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMAAdminsServiceImpl
 * @see com.pacnet.connect.service.SMAAdminsServiceUtil
 * @generated
 */
public abstract class SMAAdminsServiceBaseImpl extends BaseServiceImpl
	implements SMAAdminsService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMAAdminsServiceUtil} to access the s m a admins remote service.
	 */
	...
	private SMAAdminsServiceClpInvoker _clpInvoker = new SMAAdminsServiceClpInvoker();
}