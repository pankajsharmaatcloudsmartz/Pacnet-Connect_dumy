...
/**
 * The base implementation of the s m a radacct remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMARadacctServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMARadacctServiceImpl
 * @see com.pacnet.connect.service.SMARadacctServiceUtil
 * @generated
 */
public abstract class SMARadacctServiceBaseImpl extends BaseServiceImpl
	implements SMARadacctService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMARadacctServiceUtil} to access the s m a radacct remote service.
	 */
	...
	private SMARadacctServiceClpInvoker _clpInvoker = new SMARadacctServiceClpInvoker();
}