...
/**
 * The base implementation of the access request note history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestNoteHistoryServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.AccessRequestNoteHistoryServiceImpl
 * @see com.pacnet.connect.service.AccessRequestNoteHistoryServiceUtil
 * @generated
 */
public abstract class AccessRequestNoteHistoryServiceBaseImpl
	extends BaseServiceImpl implements AccessRequestNoteHistoryService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestNoteHistoryServiceUtil} to access the access request note history remote service.
	 */
	...
	private AccessRequestNoteHistoryServiceClpInvoker _clpInvoker = new AccessRequestNoteHistoryServiceClpInvoker();
}