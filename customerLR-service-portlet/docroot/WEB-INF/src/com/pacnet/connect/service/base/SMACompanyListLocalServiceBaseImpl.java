...
/**
 * The base implementation of the s m a company list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMACompanyListLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class SMACompanyListLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SMACompanyListLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMACompanyListLocalServiceUtil} to access the s m a company list local service.
	 */
	...
	public SMACompanyList addSMACompanyList(SMACompanyList smaCompanyList)
		throws SystemException {
		smaCompanyList.setNew(true);

		return smaCompanyListPersistence.update(smaCompanyList, false);
	}
	 ...
	 */
	public SMACompanyList createSMACompanyList(String id) {
		return smaCompanyListPersistence.create(id);
	}
	...
	public SMACompanyList deleteSMACompanyList(String id)
		throws PortalException, SystemException {
		return smaCompanyListPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SMACompanyList deleteSMACompanyList(SMACompanyList smaCompanyList)
		throws SystemException {
		return smaCompanyListPersistence.remove(smaCompanyList);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SMACompanyList.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaCompanyListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaCompanyListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SMACompanyList fetchSMACompanyList(String id)
		throws SystemException {
		return smaCompanyListPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SMACompanyList getSMACompanyList(String id)
		throws PortalException, SystemException {
		return smaCompanyListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return smaCompanyListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SMACompanyList> getSMACompanyLists(int start, int end)
		throws SystemException {
		return smaCompanyListPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSMACompanyListsCount() throws SystemException {
		return smaCompanyListPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMACompanyList updateSMACompanyList(SMACompanyList smaCompanyList)
		throws SystemException {
		return updateSMACompanyList(smaCompanyList, true);
	}
	...
	public SMACompanyList updateSMACompanyList(SMACompanyList smaCompanyList,
		...
		return smaCompanyListPersistence.update(smaCompanyList, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.SMACompanyList",
			smaCompanyListLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = smaCompanyListPersistence.getDataSource();
	...
	private SMACompanyListLocalServiceClpInvoker _clpInvoker = new SMACompanyListLocalServiceClpInvoker();
}