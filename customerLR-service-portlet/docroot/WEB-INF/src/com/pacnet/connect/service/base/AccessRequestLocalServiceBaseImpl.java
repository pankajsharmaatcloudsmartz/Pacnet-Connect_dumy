...
/**
 * The base implementation of the access request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class AccessRequestLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccessRequestLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestLocalServiceUtil} to access the access request local service.
	 */
	...
	public AccessRequest addAccessRequest(AccessRequest accessRequest)
		...
		return accessRequestPersistence.update(accessRequest, false);
	}
	 ...
	 */
	public AccessRequest createAccessRequest(long id) {
		return accessRequestPersistence.create(id);
	}
	...
	public AccessRequest deleteAccessRequest(long id)
		throws PortalException, SystemException {
		return accessRequestPersistence.remove(id);
	}
	...
	public AccessRequest deleteAccessRequest(AccessRequest accessRequest)
		throws SystemException {
		return accessRequestPersistence.remove(accessRequest);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AccessRequest.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AccessRequest fetchAccessRequest(long id) throws SystemException {
		return accessRequestPersistence.fetchByPrimaryKey(id);
	}
	...
	public AccessRequest getAccessRequest(long id)
		throws PortalException, SystemException {
		return accessRequestPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return accessRequestPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AccessRequest> getAccessRequests(int start, int end)
		throws SystemException {
		return accessRequestPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccessRequestsCount() throws SystemException {
		return accessRequestPersistence.countAll();
	}
	...
	public AccessRequest updateAccessRequest(AccessRequest accessRequest)
		throws SystemException {
		return updateAccessRequest(accessRequest, true);
	}
	...
	public AccessRequest updateAccessRequest(AccessRequest accessRequest,
		...
		return accessRequestPersistence.update(accessRequest, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.AccessRequest",
			accessRequestLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = accessRequestPersistence.getDataSource();
	...
	private AccessRequestLocalServiceClpInvoker _clpInvoker = new AccessRequestLocalServiceClpInvoker();
}