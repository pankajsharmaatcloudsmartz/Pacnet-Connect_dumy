...
/**
 * The base implementation of the facility local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
...
public abstract class FacilityLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityLocalServiceUtil} to access the facility local service.
	 */
	...
	public Facility addFacility(Facility facility) throws SystemException {
		...
		return facilityPersistence.update(facility, false);
	}
	 ...
	 */
	public Facility createFacility(long id) {
		return facilityPersistence.create(id);
	}
	...
	public Facility deleteFacility(long id)
		...
		return facilityPersistence.remove(id);
	}
	...
	public Facility fetchFacility(long id) throws SystemException {
		return facilityPersistence.fetchByPrimaryKey(id);
	}
	...
	public Facility getFacility(long id)
		throws PortalException, SystemException {
		return facilityPersistence.findByPrimaryKey(id);
	}
	...
	public Facility updateFacility(Facility facility) throws SystemException {
		return updateFacility(facility, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Facility updateFacility(Facility facility, boolean merge)
		throws SystemException {
		facility.setNew(false);

		return facilityPersistence.update(facility, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.Facility",
