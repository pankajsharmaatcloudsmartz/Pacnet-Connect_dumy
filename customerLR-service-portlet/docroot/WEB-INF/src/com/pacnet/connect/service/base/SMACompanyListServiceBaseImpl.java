...
/**
 * The base implementation of the s m a company list remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMACompanyListServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMACompanyListServiceImpl
 * @see com.pacnet.connect.service.SMACompanyListServiceUtil
 * @generated
 */
public abstract class SMACompanyListServiceBaseImpl extends BaseServiceImpl
	implements SMACompanyListService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMACompanyListServiceUtil} to access the s m a company list remote service.
	 */
	...
	private SMACompanyListServiceClpInvoker _clpInvoker = new SMACompanyListServiceClpInvoker();
}