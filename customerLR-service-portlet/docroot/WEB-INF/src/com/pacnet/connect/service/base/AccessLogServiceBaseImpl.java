...
/**
 * The base implementation of the access log remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessLogServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.AccessLogServiceImpl
 * @see com.pacnet.connect.service.AccessLogServiceUtil
 * @generated
 */
public abstract class AccessLogServiceBaseImpl extends BaseServiceImpl
	implements AccessLogService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessLogServiceUtil} to access the access log remote service.
	 */
	...
	private AccessLogServiceClpInvoker _clpInvoker = new AccessLogServiceClpInvoker();
}