...
/**
 * The base implementation of the facility access local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityAccessLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class FacilityAccessLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FacilityAccessLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityAccessLocalServiceUtil} to access the facility access local service.
	 */
	...
	public FacilityAccess addFacilityAccess(FacilityAccess facilityAccess)
		throws SystemException {
		facilityAccess.setNew(true);

		return facilityAccessPersistence.update(facilityAccess, false);
	}
	 ...
	 */
	public FacilityAccess createFacilityAccess(long id) {
		return facilityAccessPersistence.create(id);
	}
	...
	public FacilityAccess deleteFacilityAccess(long id)
		throws PortalException, SystemException {
		return facilityAccessPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FacilityAccess deleteFacilityAccess(FacilityAccess facilityAccess)
		throws SystemException {
		return facilityAccessPersistence.remove(facilityAccess);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FacilityAccess.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilityAccessPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilityAccessPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FacilityAccess fetchFacilityAccess(long id)
		throws SystemException {
		return facilityAccessPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FacilityAccess getFacilityAccess(long id)
		throws PortalException, SystemException {
		return facilityAccessPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return facilityAccessPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacilityAccess> getFacilityAccesses(int start, int end)
		throws SystemException {
		return facilityAccessPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFacilityAccessesCount() throws SystemException {
		return facilityAccessPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FacilityAccess updateFacilityAccess(FacilityAccess facilityAccess)
		throws SystemException {
		return updateFacilityAccess(facilityAccess, true);
	}
	...
	public FacilityAccess updateFacilityAccess(FacilityAccess facilityAccess,
		...
		return facilityAccessPersistence.update(facilityAccess, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.FacilityAccess",
			facilityAccessLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facilityAccessPersistence.getDataSource();
	...
	private FacilityAccessLocalServiceClpInvoker _clpInvoker = new FacilityAccessLocalServiceClpInvoker();
}