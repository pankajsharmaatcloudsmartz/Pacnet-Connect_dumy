...
/**
 * The base implementation of the s m a email history remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMAEmailHistoryServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMAEmailHistoryServiceImpl
 * @see com.pacnet.connect.service.SMAEmailHistoryServiceUtil
 * @generated
 */
public abstract class SMAEmailHistoryServiceBaseImpl extends BaseServiceImpl
	implements SMAEmailHistoryService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMAEmailHistoryServiceUtil} to access the s m a email history remote service.
	 */
	...
	private SMAEmailHistoryServiceClpInvoker _clpInvoker = new SMAEmailHistoryServiceClpInvoker();
}