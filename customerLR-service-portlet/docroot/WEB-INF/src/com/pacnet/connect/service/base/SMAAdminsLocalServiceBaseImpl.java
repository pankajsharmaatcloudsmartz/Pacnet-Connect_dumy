...
/**
 * The base implementation of the s m a admins local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMAAdminsLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class SMAAdminsLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements SMAAdminsLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMAAdminsLocalServiceUtil} to access the s m a admins local service.
	 */
	...
	public SMAAdmins addSMAAdmins(SMAAdmins smaAdmins)
		throws SystemException {
		smaAdmins.setNew(true);

		return smaAdminsPersistence.update(smaAdmins, false);
	}
	 ...
	 */
	public SMAAdmins createSMAAdmins(long id) {
		return smaAdminsPersistence.create(id);
	}
	...
	public SMAAdmins deleteSMAAdmins(long id)
		throws PortalException, SystemException {
		return smaAdminsPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SMAAdmins deleteSMAAdmins(SMAAdmins smaAdmins)
		throws SystemException {
		return smaAdminsPersistence.remove(smaAdmins);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SMAAdmins.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaAdminsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return smaAdminsPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaAdminsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SMAAdmins fetchSMAAdmins(long id) throws SystemException {
		return smaAdminsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SMAAdmins getSMAAdmins(long id)
		throws PortalException, SystemException {
		return smaAdminsPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return smaAdminsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SMAAdmins> getSMAAdminses(int start, int end)
		throws SystemException {
		return smaAdminsPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSMAAdminsesCount() throws SystemException {
		return smaAdminsPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMAAdmins updateSMAAdmins(SMAAdmins smaAdmins)
		throws SystemException {
		return updateSMAAdmins(smaAdmins, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMAAdmins updateSMAAdmins(SMAAdmins smaAdmins, boolean merge)
		throws SystemException {
		smaAdmins.setNew(false);

		return smaAdminsPersistence.update(smaAdmins, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.SMAAdmins",
			smaAdminsLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = smaAdminsPersistence.getDataSource();
	...
	private SMAAdminsLocalServiceClpInvoker _clpInvoker = new SMAAdminsLocalServiceClpInvoker();
}