 ...
 */
public class SMAAdminsServiceClpInvoker {
	public SMAAdminsServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName136.equals(name) &&
			...
			return SMAAdminsServiceUtil.getBeanIdentifier();
		}

		if (_methodName137.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes137, parameterTypes)) {
			SMAAdminsServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		}
