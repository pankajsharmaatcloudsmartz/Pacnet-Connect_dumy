...
/**
 * The base implementation of the access log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessLogLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class AccessLogLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AccessLogLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessLogLocalServiceUtil} to access the access log local service.
	 */
	...
	public AccessLog addAccessLog(AccessLog accessLog)
		...
		return accessLogPersistence.update(accessLog, false);
	}
	 ...
	 */
	public AccessLog createAccessLog(long id) {
		return accessLogPersistence.create(id);
	}
	...
	public AccessLog deleteAccessLog(long id)
		throws PortalException, SystemException {
		return accessLogPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AccessLog deleteAccessLog(AccessLog accessLog)
		throws SystemException {
		return accessLogPersistence.remove(accessLog);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AccessLog.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return accessLogPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessLogPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AccessLog fetchAccessLog(long id) throws SystemException {
		return accessLogPersistence.fetchByPrimaryKey(id);
	}
	...
	public AccessLog getAccessLog(long id)
		throws PortalException, SystemException {
		return accessLogPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return accessLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AccessLog> getAccessLogs(int start, int end)
		throws SystemException {
		return accessLogPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccessLogsCount() throws SystemException {
		return accessLogPersistence.countAll();
	}
	...
	public AccessLog updateAccessLog(AccessLog accessLog)
		throws SystemException {
		return updateAccessLog(accessLog, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccessLog updateAccessLog(AccessLog accessLog, boolean merge)
		throws SystemException {
		accessLog.setNew(false);

		return accessLogPersistence.update(accessLog, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.AccessLog",
			accessLogLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = accessLogPersistence.getDataSource();
	...
	private AccessLogLocalServiceClpInvoker _clpInvoker = new AccessLogLocalServiceClpInvoker();
}