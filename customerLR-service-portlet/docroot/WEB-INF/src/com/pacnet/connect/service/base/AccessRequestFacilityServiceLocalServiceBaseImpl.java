...
/**
 * The base implementation of the access request facility service local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestFacilityServiceLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class AccessRequestFacilityServiceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AccessRequestFacilityServiceLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestFacilityServiceLocalServiceUtil} to access the access request facility service local service.
	 */
	...
	public AccessRequestFacilityService addAccessRequestFacilityService(
		AccessRequestFacilityService accessRequestFacilityService)
		throws SystemException {
		accessRequestFacilityService.setNew(true);

		return accessRequestFacilityServicePersistence.update(accessRequestFacilityService,
			false);
	}
	 ...
	 */
	public AccessRequestFacilityService createAccessRequestFacilityService(
		long id) {
		return accessRequestFacilityServicePersistence.create(id);
	}
	...
	public AccessRequestFacilityService deleteAccessRequestFacilityService(
		long id) throws PortalException, SystemException {
		return accessRequestFacilityServicePersistence.remove(id);
	}
	...
	public AccessRequestFacilityService deleteAccessRequestFacilityService(
		AccessRequestFacilityService accessRequestFacilityService)
		throws SystemException {
		return accessRequestFacilityServicePersistence.remove(accessRequestFacilityService);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AccessRequestFacilityService.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessRequestFacilityServicePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessRequestFacilityServicePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AccessRequestFacilityService fetchAccessRequestFacilityService(
		long id) throws SystemException {
		return accessRequestFacilityServicePersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the access request facility service with the primary key.
	 *
	 * @param id the primary key of the access request facility service
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AccessRequestFacilityService getAccessRequestFacilityService(long id)
		throws PortalException, SystemException {
		return accessRequestFacilityServicePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return accessRequestFacilityServicePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AccessRequestFacilityService> getAccessRequestFacilityServices(
		int start, int end) throws SystemException {
		return accessRequestFacilityServicePersistence.findAll(start, end);
	}
	...
	public int getAccessRequestFacilityServicesCount()
		throws SystemException {
		return accessRequestFacilityServicePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccessRequestFacilityService updateAccessRequestFacilityService(
		AccessRequestFacilityService accessRequestFacilityService)
		throws SystemException {
		return updateAccessRequestFacilityService(accessRequestFacilityService,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.AccessRequestFacilityService",
			accessRequestFacilityServiceLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = accessRequestFacilityServicePersistence.getDataSource();
	...
	private AccessRequestFacilityServiceLocalServiceClpInvoker _clpInvoker = new AccessRequestFacilityServiceLocalServiceClpInvoker();
}