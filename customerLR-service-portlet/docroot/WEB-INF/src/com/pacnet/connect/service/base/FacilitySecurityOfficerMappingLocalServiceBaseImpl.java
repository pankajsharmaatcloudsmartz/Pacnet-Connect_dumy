...
/**
 * The base implementation of the facility security officer mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilitySecurityOfficerMappingLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class FacilitySecurityOfficerMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements FacilitySecurityOfficerMappingLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilitySecurityOfficerMappingLocalServiceUtil} to access the facility security officer mapping local service.
	 */
	...
	public FacilitySecurityOfficerMapping addFacilitySecurityOfficerMapping(
		FacilitySecurityOfficerMapping facilitySecurityOfficerMapping)
		throws SystemException {
		facilitySecurityOfficerMapping.setNew(true);

		return facilitySecurityOfficerMappingPersistence.update(facilitySecurityOfficerMapping,
			false);
	}
	 ...
	 */
	public FacilitySecurityOfficerMapping createFacilitySecurityOfficerMapping(
		long id) {
		return facilitySecurityOfficerMappingPersistence.create(id);
	}
	...
	public FacilitySecurityOfficerMapping deleteFacilitySecurityOfficerMapping(
		long id) throws PortalException, SystemException {
		return facilitySecurityOfficerMappingPersistence.remove(id);
	}
	...
	public FacilitySecurityOfficerMapping deleteFacilitySecurityOfficerMapping(
		FacilitySecurityOfficerMapping facilitySecurityOfficerMapping)
		throws SystemException {
		return facilitySecurityOfficerMappingPersistence.remove(facilitySecurityOfficerMapping);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FacilitySecurityOfficerMapping.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilitySecurityOfficerMappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilitySecurityOfficerMappingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FacilitySecurityOfficerMapping fetchFacilitySecurityOfficerMapping(
		long id) throws SystemException {
		return facilitySecurityOfficerMappingPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FacilitySecurityOfficerMapping getFacilitySecurityOfficerMapping(
		long id) throws PortalException, SystemException {
		return facilitySecurityOfficerMappingPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return facilitySecurityOfficerMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacilitySecurityOfficerMapping> getFacilitySecurityOfficerMappings(
		int start, int end) throws SystemException {
		return facilitySecurityOfficerMappingPersistence.findAll(start, end);
	}
	...
	public int getFacilitySecurityOfficerMappingsCount()
		throws SystemException {
		return facilitySecurityOfficerMappingPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FacilitySecurityOfficerMapping updateFacilitySecurityOfficerMapping(
		FacilitySecurityOfficerMapping facilitySecurityOfficerMapping)
		throws SystemException {
		return updateFacilitySecurityOfficerMapping(facilitySecurityOfficerMapping,
			true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.FacilitySecurityOfficerMapping",
			facilitySecurityOfficerMappingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facilitySecurityOfficerMappingPersistence.getDataSource();
	...
	private FacilitySecurityOfficerMappingLocalServiceClpInvoker _clpInvoker = new FacilitySecurityOfficerMappingLocalServiceClpInvoker();
}