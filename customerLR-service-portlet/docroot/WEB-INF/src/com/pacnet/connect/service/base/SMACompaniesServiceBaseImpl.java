...
/**
 * The base implementation of the s m a companies remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMACompaniesServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMACompaniesServiceImpl
 * @see com.pacnet.connect.service.SMACompaniesServiceUtil
 * @generated
 */
public abstract class SMACompaniesServiceBaseImpl extends BaseServiceImpl
	implements SMACompaniesService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMACompaniesServiceUtil} to access the s m a companies remote service.
	 */
	...
	private SMACompaniesServiceClpInvoker _clpInvoker = new SMACompaniesServiceClpInvoker();
}