...
/**
 * The base implementation of the facility external visitor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityExternalVisitorLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class FacilityExternalVisitorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FacilityExternalVisitorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityExternalVisitorLocalServiceUtil} to access the facility external visitor local service.
	 */
	...
	public FacilityExternalVisitor addFacilityExternalVisitor(
		FacilityExternalVisitor facilityExternalVisitor)
		throws SystemException {
		facilityExternalVisitor.setNew(true);

		return facilityExternalVisitorPersistence.update(facilityExternalVisitor,
			false);
	}
	 ...
	 */
	public FacilityExternalVisitor createFacilityExternalVisitor(long id) {
		return facilityExternalVisitorPersistence.create(id);
	}
	...
	public FacilityExternalVisitor deleteFacilityExternalVisitor(long id)
		throws PortalException, SystemException {
		return facilityExternalVisitorPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FacilityExternalVisitor deleteFacilityExternalVisitor(
		FacilityExternalVisitor facilityExternalVisitor)
		throws SystemException {
		return facilityExternalVisitorPersistence.remove(facilityExternalVisitor);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FacilityExternalVisitor.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilityExternalVisitorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilityExternalVisitorPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FacilityExternalVisitor fetchFacilityExternalVisitor(long id)
		throws SystemException {
		return facilityExternalVisitorPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FacilityExternalVisitor getFacilityExternalVisitor(long id)
		throws PortalException, SystemException {
		return facilityExternalVisitorPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return facilityExternalVisitorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacilityExternalVisitor> getFacilityExternalVisitors(
		int start, int end) throws SystemException {
		return facilityExternalVisitorPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFacilityExternalVisitorsCount() throws SystemException {
		return facilityExternalVisitorPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FacilityExternalVisitor updateFacilityExternalVisitor(
		FacilityExternalVisitor facilityExternalVisitor)
		throws SystemException {
		return updateFacilityExternalVisitor(facilityExternalVisitor, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.FacilityExternalVisitor",
			facilityExternalVisitorLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facilityExternalVisitorPersistence.getDataSource();
	...
	private FacilityExternalVisitorLocalServiceClpInvoker _clpInvoker = new FacilityExternalVisitorLocalServiceClpInvoker();
}