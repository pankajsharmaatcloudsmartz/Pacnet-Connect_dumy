...
/**
 * The base implementation of the access request remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.AccessRequestServiceImpl
 * @see com.pacnet.connect.service.AccessRequestServiceUtil
 * @generated
 */
public abstract class AccessRequestServiceBaseImpl extends BaseServiceImpl
	implements AccessRequestService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestServiceUtil} to access the access request remote service.
	 */
	...
	private AccessRequestServiceClpInvoker _clpInvoker = new AccessRequestServiceClpInvoker();
}