...
/**
 * The base implementation of the s m a reservation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMAReservationServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMAReservationServiceImpl
 * @see com.pacnet.connect.service.SMAReservationServiceUtil
 * @generated
 */
public abstract class SMAReservationServiceBaseImpl extends BaseServiceImpl
	implements SMAReservationService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMAReservationServiceUtil} to access the s m a reservation remote service.
	 */
	...
	private SMAReservationServiceClpInvoker _clpInvoker = new SMAReservationServiceClpInvoker();
}