...
/**
 * The base implementation of the s m a companies local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMACompaniesLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class SMACompaniesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SMACompaniesLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMACompaniesLocalServiceUtil} to access the s m a companies local service.
	 */
	...
	public SMACompanies addSMACompanies(SMACompanies smaCompanies)
		throws SystemException {
		smaCompanies.setNew(true);

		return smaCompaniesPersistence.update(smaCompanies, false);
	}
	 ...
	 */
	public SMACompanies createSMACompanies(long id) {
		return smaCompaniesPersistence.create(id);
	}
	...
	public SMACompanies deleteSMACompanies(long id)
		throws PortalException, SystemException {
		return smaCompaniesPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SMACompanies deleteSMACompanies(SMACompanies smaCompanies)
		throws SystemException {
		return smaCompaniesPersistence.remove(smaCompanies);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SMACompanies.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaCompaniesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaCompaniesPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SMACompanies fetchSMACompanies(long id) throws SystemException {
		return smaCompaniesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SMACompanies getSMACompanies(long id)
		throws PortalException, SystemException {
		return smaCompaniesPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return smaCompaniesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SMACompanies> getSMACompanieses(int start, int end)
		throws SystemException {
		return smaCompaniesPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSMACompaniesesCount() throws SystemException {
		return smaCompaniesPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMACompanies updateSMACompanies(SMACompanies smaCompanies)
		throws SystemException {
		return updateSMACompanies(smaCompanies, true);
	}
	...
	public SMACompanies updateSMACompanies(SMACompanies smaCompanies,
		...
		return smaCompaniesPersistence.update(smaCompanies, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.SMACompanies",
			smaCompaniesLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = smaCompaniesPersistence.getDataSource();
	...
	private SMACompaniesLocalServiceClpInvoker _clpInvoker = new SMACompaniesLocalServiceClpInvoker();
}