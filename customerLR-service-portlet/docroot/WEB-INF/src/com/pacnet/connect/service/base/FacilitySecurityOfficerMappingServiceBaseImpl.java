...
/**
 * The base implementation of the facility security officer mapping remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilitySecurityOfficerMappingServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.FacilitySecurityOfficerMappingServiceImpl
 * @see com.pacnet.connect.service.FacilitySecurityOfficerMappingServiceUtil
 * @generated
 */
public abstract class FacilitySecurityOfficerMappingServiceBaseImpl
	extends BaseServiceImpl implements FacilitySecurityOfficerMappingService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilitySecurityOfficerMappingServiceUtil} to access the facility security officer mapping remote service.
	 */
	...
	private FacilitySecurityOfficerMappingServiceClpInvoker _clpInvoker = new FacilitySecurityOfficerMappingServiceClpInvoker();
}