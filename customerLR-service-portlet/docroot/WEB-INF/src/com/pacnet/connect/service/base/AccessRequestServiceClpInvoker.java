 ...
 */
public class AccessRequestServiceClpInvoker {
	public AccessRequestServiceClpInvoker() {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName136.equals(name) &&
			...
			return AccessRequestServiceUtil.getBeanIdentifier();
		}

		if (_methodName137.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes137, parameterTypes)) {
			AccessRequestServiceUtil.setBeanIdentifier((java.lang.String)arguments[0]);
		}
