...
/**
 * The base implementation of the facility assignment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityAssignmentLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class FacilityAssignmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FacilityAssignmentLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityAssignmentLocalServiceUtil} to access the facility assignment local service.
	 */
	...
	public FacilityAssignment addFacilityAssignment(
		FacilityAssignment facilityAssignment) throws SystemException {
		facilityAssignment.setNew(true);

		return facilityAssignmentPersistence.update(facilityAssignment, false);
	}
	 ...
	 */
	public FacilityAssignment createFacilityAssignment(long id) {
		return facilityAssignmentPersistence.create(id);
	}
	...
	public FacilityAssignment deleteFacilityAssignment(long id)
		throws PortalException, SystemException {
		return facilityAssignmentPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FacilityAssignment deleteFacilityAssignment(
		FacilityAssignment facilityAssignment) throws SystemException {
		return facilityAssignmentPersistence.remove(facilityAssignment);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FacilityAssignment.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return facilityAssignmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilityAssignmentPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FacilityAssignment fetchFacilityAssignment(long id)
		throws SystemException {
		return facilityAssignmentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FacilityAssignment getFacilityAssignment(long id)
		throws PortalException, SystemException {
		return facilityAssignmentPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return facilityAssignmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacilityAssignment> getFacilityAssignments(int start, int end)
		throws SystemException {
		return facilityAssignmentPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFacilityAssignmentsCount() throws SystemException {
		return facilityAssignmentPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FacilityAssignment updateFacilityAssignment(
		FacilityAssignment facilityAssignment) throws SystemException {
		return updateFacilityAssignment(facilityAssignment, true);
	}
	...
	public FacilityAssignment updateFacilityAssignment(
		...
		return facilityAssignmentPersistence.update(facilityAssignment, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.FacilityAssignment",
			facilityAssignmentLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facilityAssignmentPersistence.getDataSource();
	...
	private FacilityAssignmentLocalServiceClpInvoker _clpInvoker = new FacilityAssignmentLocalServiceClpInvoker();
}