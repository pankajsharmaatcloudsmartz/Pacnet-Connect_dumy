...
/**
 * The base implementation of the s m a radacct local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMARadacctLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class SMARadacctLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SMARadacctLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMARadacctLocalServiceUtil} to access the s m a radacct local service.
	 */
	...
	public SMARadacct addSMARadacct(SMARadacct smaRadacct)
		throws SystemException {
		smaRadacct.setNew(true);

		return smaRadacctPersistence.update(smaRadacct, false);
	}
	 ...
	 */
	public SMARadacct createSMARadacct(long radAcctId) {
		return smaRadacctPersistence.create(radAcctId);
	}
	...
	public SMARadacct deleteSMARadacct(long radAcctId)
		throws PortalException, SystemException {
		return smaRadacctPersistence.remove(radAcctId);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SMARadacct deleteSMARadacct(SMARadacct smaRadacct)
		throws SystemException {
		return smaRadacctPersistence.remove(smaRadacct);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SMARadacct.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaRadacctPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return smaRadacctPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaRadacctPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SMARadacct fetchSMARadacct(long radAcctId) throws SystemException {
		return smaRadacctPersistence.fetchByPrimaryKey(radAcctId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SMARadacct getSMARadacct(long radAcctId)
		throws PortalException, SystemException {
		return smaRadacctPersistence.findByPrimaryKey(radAcctId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return smaRadacctPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SMARadacct> getSMARadaccts(int start, int end)
		throws SystemException {
		return smaRadacctPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSMARadacctsCount() throws SystemException {
		return smaRadacctPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMARadacct updateSMARadacct(SMARadacct smaRadacct)
		throws SystemException {
		return updateSMARadacct(smaRadacct, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMARadacct updateSMARadacct(SMARadacct smaRadacct, boolean merge)
		throws SystemException {
		smaRadacct.setNew(false);

		return smaRadacctPersistence.update(smaRadacct, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.SMARadacct",
			smaRadacctLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = smaRadacctPersistence.getDataSource();
	...
	private SMARadacctLocalServiceClpInvoker _clpInvoker = new SMARadacctLocalServiceClpInvoker();
}