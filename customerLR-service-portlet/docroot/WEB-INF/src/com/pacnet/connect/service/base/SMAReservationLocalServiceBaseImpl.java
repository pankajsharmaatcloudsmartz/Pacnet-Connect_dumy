...
/**
 * The base implementation of the s m a reservation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMAReservationLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class SMAReservationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements SMAReservationLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMAReservationLocalServiceUtil} to access the s m a reservation local service.
	 */
	...
	public SMAReservation addSMAReservation(SMAReservation smaReservation)
		throws SystemException {
		smaReservation.setNew(true);

		return smaReservationPersistence.update(smaReservation, false);
	}
	 ...
	 */
	public SMAReservation createSMAReservation(long id) {
		return smaReservationPersistence.create(id);
	}
	...
	public SMAReservation deleteSMAReservation(long id)
		throws PortalException, SystemException {
		return smaReservationPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SMAReservation deleteSMAReservation(SMAReservation smaReservation)
		throws SystemException {
		return smaReservationPersistence.remove(smaReservation);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(SMAReservation.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaReservationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return smaReservationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public SMAReservation fetchSMAReservation(long id)
		throws SystemException {
		return smaReservationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public SMAReservation getSMAReservation(long id)
		throws PortalException, SystemException {
		return smaReservationPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return smaReservationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SMAReservation> getSMAReservations(int start, int end)
		throws SystemException {
		return smaReservationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getSMAReservationsCount() throws SystemException {
		return smaReservationPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SMAReservation updateSMAReservation(SMAReservation smaReservation)
		throws SystemException {
		return updateSMAReservation(smaReservation, true);
	}
	...
	public SMAReservation updateSMAReservation(SMAReservation smaReservation,
		...
		return smaReservationPersistence.update(smaReservation, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.SMAReservation",
			smaReservationLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = smaReservationPersistence.getDataSource();
	...
	private SMAReservationLocalServiceClpInvoker _clpInvoker = new SMAReservationLocalServiceClpInvoker();
}