...
/**
 * The base implementation of the access request status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.AccessRequestStatusLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.AccessRequestStatusLocalServiceImpl
 * @see com.pacnet.connect.service.AccessRequestStatusLocalServiceUtil
 * @generated
 */
public abstract class AccessRequestStatusLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements AccessRequestStatusLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.AccessRequestStatusLocalServiceUtil} to access the access request status local service.
	 */
	...
	public AccessRequestStatus addAccessRequestStatus(
		AccessRequestStatus accessRequestStatus) throws SystemException {
		accessRequestStatus.setNew(true);

		return accessRequestStatusPersistence.update(accessRequestStatus, false);
	}
	 ...
	 */
	public AccessRequestStatus createAccessRequestStatus(long id) {
		return accessRequestStatusPersistence.create(id);
	}
	...
	public AccessRequestStatus deleteAccessRequestStatus(long id)
		throws PortalException, SystemException {
		return accessRequestStatusPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AccessRequestStatus deleteAccessRequestStatus(
		AccessRequestStatus accessRequestStatus) throws SystemException {
		return accessRequestStatusPersistence.remove(accessRequestStatus);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(AccessRequestStatus.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return accessRequestStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return accessRequestStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public AccessRequestStatus fetchAccessRequestStatus(long id)
		throws SystemException {
		return accessRequestStatusPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public AccessRequestStatus getAccessRequestStatus(long id)
		throws PortalException, SystemException {
		return accessRequestStatusPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return accessRequestStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AccessRequestStatus> getAccessRequestStatuses(int start, int end)
		throws SystemException {
		return accessRequestStatusPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getAccessRequestStatusesCount() throws SystemException {
		return accessRequestStatusPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AccessRequestStatus updateAccessRequestStatus(
		AccessRequestStatus accessRequestStatus) throws SystemException {
		return updateAccessRequestStatus(accessRequestStatus, true);
	}
	...
	public AccessRequestStatus updateAccessRequestStatus(
		...
		return accessRequestStatusPersistence.update(accessRequestStatus, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.AccessRequestStatus",
			accessRequestStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.pacnet.connect.model.AccessRequestStatus");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = accessRequestStatusPersistence.getDataSource();
	...
	private AccessRequestStatusLocalServiceClpInvoker _clpInvoker = new AccessRequestStatusLocalServiceClpInvoker();
}