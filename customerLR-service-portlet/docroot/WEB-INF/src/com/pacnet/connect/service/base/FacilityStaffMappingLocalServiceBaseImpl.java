...
/**
 * The base implementation of the facility staff mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityStaffMappingLocalServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 ...
 * @generated
 */
public abstract class FacilityStaffMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements FacilityStaffMappingLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityStaffMappingLocalServiceUtil} to access the facility staff mapping local service.
	 */
	...
	public FacilityStaffMapping addFacilityStaffMapping(
		FacilityStaffMapping facilityStaffMapping) throws SystemException {
		facilityStaffMapping.setNew(true);

		return facilityStaffMappingPersistence.update(facilityStaffMapping,
			false);
	}
	 ...
	 */
	public FacilityStaffMapping createFacilityStaffMapping(long id) {
		return facilityStaffMappingPersistence.create(id);
	}
	...
	public FacilityStaffMapping deleteFacilityStaffMapping(long id)
		throws PortalException, SystemException {
		return facilityStaffMappingPersistence.remove(id);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FacilityStaffMapping deleteFacilityStaffMapping(
		FacilityStaffMapping facilityStaffMapping) throws SystemException {
		return facilityStaffMappingPersistence.remove(facilityStaffMapping);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(FacilityStaffMapping.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return facilityStaffMappingPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facilityStaffMappingPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public FacilityStaffMapping fetchFacilityStaffMapping(long id)
		throws SystemException {
		return facilityStaffMappingPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public FacilityStaffMapping getFacilityStaffMapping(long id)
		throws PortalException, SystemException {
		return facilityStaffMappingPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return facilityStaffMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacilityStaffMapping> getFacilityStaffMappings(int start,
		int end) throws SystemException {
		return facilityStaffMappingPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getFacilityStaffMappingsCount() throws SystemException {
		return facilityStaffMappingPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FacilityStaffMapping updateFacilityStaffMapping(
		FacilityStaffMapping facilityStaffMapping) throws SystemException {
		return updateFacilityStaffMapping(facilityStaffMapping, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("com.pacnet.connect.model.FacilityStaffMapping",
			facilityStaffMappingLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facilityStaffMappingPersistence.getDataSource();
	...
	private FacilityStaffMappingLocalServiceClpInvoker _clpInvoker = new FacilityStaffMappingLocalServiceClpInvoker();
}