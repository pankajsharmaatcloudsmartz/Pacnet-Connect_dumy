...
/**
 * The base implementation of the s m a radcheck remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.SMARadcheckServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.SMARadcheckServiceImpl
 * @see com.pacnet.connect.service.SMARadcheckServiceUtil
 * @generated
 */
public abstract class SMARadcheckServiceBaseImpl extends BaseServiceImpl
	implements SMARadcheckService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.SMARadcheckServiceUtil} to access the s m a radcheck remote service.
	 */
	...
	private SMARadcheckServiceClpInvoker _clpInvoker = new SMARadcheckServiceClpInvoker();
}