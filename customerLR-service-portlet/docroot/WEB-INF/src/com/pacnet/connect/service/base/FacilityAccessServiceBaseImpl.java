...
/**
 * The base implementation of the facility access remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.pacnet.connect.service.impl.FacilityAccessServiceImpl}.
 * </p>
 *
 * @author CloudSmartz
 * @see com.pacnet.connect.service.impl.FacilityAccessServiceImpl
 * @see com.pacnet.connect.service.FacilityAccessServiceUtil
 * @generated
 */
public abstract class FacilityAccessServiceBaseImpl extends BaseServiceImpl
	implements FacilityAccessService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.pacnet.connect.service.FacilityAccessServiceUtil} to access the facility access remote service.
	 */
	...
	private FacilityAccessServiceClpInvoker _clpInvoker = new FacilityAccessServiceClpInvoker();
}