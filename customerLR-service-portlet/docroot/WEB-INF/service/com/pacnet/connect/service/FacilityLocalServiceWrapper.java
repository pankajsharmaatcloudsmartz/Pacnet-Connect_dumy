...
/**
 * <p>
 * This class is a wrapper for {@link FacilityLocalService}.
 * </p>
 *
 * @author    CloudSmartz
...
public class FacilityLocalServiceWrapper implements FacilityLocalService,
	...
	*/
	public com.pacnet.connect.model.Facility addFacility(
	...
	*/
	public com.pacnet.connect.model.Facility createFacility(long id) {
		return _facilityLocalService.createFacility(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public com.pacnet.connect.model.Facility deleteFacility(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.deleteFacility(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public com.pacnet.connect.model.Facility deleteFacility(
		com.pacnet.connect.model.Facility facility)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public com.pacnet.connect.model.Facility fetchFacility(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.fetchFacility(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public com.pacnet.connect.model.Facility getFacility(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.getFacility(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public java.util.List<com.pacnet.connect.model.Facility> getFacilities(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public com.pacnet.connect.model.Facility updateFacility(
		com.pacnet.connect.model.Facility facility)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public com.pacnet.connect.model.Facility updateFacility(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.updateFacility(facility, merge);
	}
	...
	*/
	...
	public com.pacnet.connect.model.Facility createFacility(
		...
		return _facilityLocalService.createFacility(facilityName, address,
			phoneNumber, city, stateId, countryId, isThirdParty,
			escalationEmail, isActive, createdBy, createdOn, updatedBy,
			updatedOn, timezone);
	}

	public com.pacnet.connect.model.Facility updateFacility(long id,
		java.lang.String facilityName, java.lang.String address,
		java.lang.String phoneNumber, java.lang.String city, long stateId,
		long countryId, int isThirdParty, java.lang.String escalationEmail,
		boolean isActive, java.lang.String createdBy, java.sql.Date createdOn,
		java.lang.String updatedBy, java.sql.Date updatedOn,
		java.lang.String timezone) {
		return _facilityLocalService.updateFacility(id, facilityName, address,
			phoneNumber, city, stateId, countryId, isThirdParty,
			escalationEmail, isActive, createdBy, createdOn, updatedBy,
			updatedOn, timezone);
	}
	...
	public boolean deleteFacilityById(long id) {
		return _facilityLocalService.deleteFacilityById(id);
	}
	...
	public java.util.List<com.pacnet.connect.model.Facility> findByFacilityName(
		...
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.findByFacilityName(name, start, end,
			orderByComparator);
	}

	public java.util.List<com.pacnet.connect.model.Facility> getAllThirdPartyFacility() {
		return _facilityLocalService.getAllThirdPartyFacility();
	}
	...
	*/
	public com.pacnet.connect.model.Facility findByFacilityName_First(
		...
		return _facilityLocalService.findByFacilityName_First(name,
			orderByComparator);
	}
	...
	*/
	public com.pacnet.connect.model.Facility fetchByFacilityName_First(
		...
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.fetchByFacilityName_First(name,
			orderByComparator);
	}
	...
	*/
	public com.pacnet.connect.model.Facility findByFacilityName_Last(
		...
		throws com.liferay.portal.kernel.exception.SystemException,
			com.pacnet.connect.NoSuchFacilityException {
		return _facilityLocalService.findByFacilityName_Last(name,
			orderByComparator);
	}
	...
	*/
	public com.pacnet.connect.model.Facility fetchByFacilityName_Last(
		...
		com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.fetchByFacilityName_Last(name,
			orderByComparator);
	}
	...
	*/
	public com.pacnet.connect.model.Facility[] findByFacilityName_PrevAndNext(
		...
		throws com.liferay.portal.kernel.exception.SystemException,
			com.pacnet.connect.NoSuchFacilityException {
		return _facilityLocalService.findByFacilityName_PrevAndNext(id, name,
			orderByComparator);
	}

	public java.util.List<com.pacnet.connect.model.Facility> findByFacilityByCountryId(
		long countryId) {
		return _facilityLocalService.findByFacilityByCountryId(countryId);
	}

	public java.util.List<com.pacnet.connect.model.Facility> findByFacilityByManagerId(
		long managerId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _facilityLocalService.findByFacilityByManagerId(managerId);
	}
