...
/**
 * The persistence utility for the s m a_ email_ history service. This utility wraps {@link SMA_Email_HistoryPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author CloudSmartz
 * @see SMA_Email_HistoryPersistence
 * @see SMA_Email_HistoryPersistenceImpl
 * @generated
 */
public class SMA_Email_HistoryUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(SMA_Email_History sma_Email_History) {
		getPersistence().clearCache(sma_Email_History);
	}
	 ...
	 */
	public static List<SMA_Email_History> findWithDynamicQuery(
	 ...
	 */
	public static SMA_Email_History update(
		SMA_Email_History sma_Email_History, boolean merge)
		throws SystemException {
		return getPersistence().update(sma_Email_History, merge);
	}
	...
	public static SMA_Email_History update(
		...
		return getPersistence().update(sma_Email_History, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(sma_Email_History);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(sma_Email_Histories);
	}
	...
	*/
	public static com.pacnet.connect.model.SMA_Email_History create(long id) {
	...
	*/
	public static com.pacnet.connect.model.SMA_Email_History remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.pacnet.connect.NoSuchSMA_Email_HistoryException {
		return getPersistence().remove(id);
	}

	public static com.pacnet.connect.model.SMA_Email_History updateImpl(
		com.pacnet.connect.model.SMA_Email_History sma_Email_History,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(sma_Email_History, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.pacnet.connect.model.SMA_Email_History findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.pacnet.connect.NoSuchSMA_Email_HistoryException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.pacnet.connect.model.SMA_Email_History fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.pacnet.connect.model.SMA_Email_History> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SMA_Email_HistoryPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SMA_Email_HistoryPersistence)PortletBeanLocatorUtil.locate(com.pacnet.connect.service.ClpSerializer.getServletContextName(),
					SMA_Email_HistoryPersistence.class.getName());

			ReferenceRegistry.registerReference(SMA_Email_HistoryUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(SMA_Email_HistoryPersistence persistence) {
	}

	private static SMA_Email_HistoryPersistence _persistence;
}