...
/**
 * The persistence utility for the s a m_ companies service. This utility wraps {@link SAM_CompaniesPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author CloudSmartz
 * @see SAM_CompaniesPersistence
 * @see SAM_CompaniesPersistenceImpl
 * @generated
 */
public class SAM_CompaniesUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(SAM_Companies sam_Companies) {
		getPersistence().clearCache(sam_Companies);
	}
	 ...
	 */
	public static List<SAM_Companies> findWithDynamicQuery(
	 ...
	 */
	public static SAM_Companies update(SAM_Companies sam_Companies,
		boolean merge) throws SystemException {
		return getPersistence().update(sam_Companies, merge);
	}
	...
	public static SAM_Companies update(SAM_Companies sam_Companies,
		...
		return getPersistence().update(sam_Companies, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(sam_Companies);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(sam_Companieses);
	}
	...
	*/
	public static com.pacnet.connect.model.SAM_Companies create(long id) {
	...
	*/
	public static com.pacnet.connect.model.SAM_Companies remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.pacnet.connect.NoSuchSAM_CompaniesException {
		return getPersistence().remove(id);
	}

	public static com.pacnet.connect.model.SAM_Companies updateImpl(
		com.pacnet.connect.model.SAM_Companies sam_Companies, boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(sam_Companies, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.pacnet.connect.model.SAM_Companies findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.pacnet.connect.NoSuchSAM_CompaniesException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.pacnet.connect.model.SAM_Companies fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.pacnet.connect.model.SAM_Companies> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static SAM_CompaniesPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (SAM_CompaniesPersistence)PortletBeanLocatorUtil.locate(com.pacnet.connect.service.ClpSerializer.getServletContextName(),
					SAM_CompaniesPersistence.class.getName());

			ReferenceRegistry.registerReference(SAM_CompaniesUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(SAM_CompaniesPersistence persistence) {
	}

	private static SAM_CompaniesPersistence _persistence;
}