...
/**
 * This class is used by SOAP remote services, specifically {@link com.pacnet.connect.service.http.SAM_radacctServiceSoap}.
 *
 * @author    CloudSmartz
 * @see       com.pacnet.connect.service.http.SAM_radacctServiceSoap
 * @generated
 */
public class SAM_radacctSoap implements Serializable {
	public static SAM_radacctSoap toSoapModel(SAM_radacct model) {
		SAM_radacctSoap soapModel = new SAM_radacctSoap();
	...
	public static SAM_radacctSoap[] toSoapModels(SAM_radacct[] models) {
		SAM_radacctSoap[] soapModels = new SAM_radacctSoap[models.length];
	...
	public static SAM_radacctSoap[][] toSoapModels(SAM_radacct[][] models) {
		SAM_radacctSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new SAM_radacctSoap[models.length][models[0].length];
		}
		else {
			soapModels = new SAM_radacctSoap[0][0];
		}
	...
	public static SAM_radacctSoap[] toSoapModels(List<SAM_radacct> models) {
		List<SAM_radacctSoap> soapModels = new ArrayList<SAM_radacctSoap>(models.size());

		for (SAM_radacct model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new SAM_radacctSoap[soapModels.size()]);
	}

	public SAM_radacctSoap() {
	}
