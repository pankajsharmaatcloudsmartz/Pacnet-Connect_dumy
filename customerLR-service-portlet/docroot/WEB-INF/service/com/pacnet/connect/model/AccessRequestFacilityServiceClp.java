 ...
 * @author CloudSmartz
 */
public class AccessRequestFacilityServiceClp extends BaseModelImpl<AccessRequestFacilityService>
	implements AccessRequestFacilityService {
	public AccessRequestFacilityServiceClp() {
	}
	...
	public BaseModel<?> getAccessRequestFacilityServiceRemoteModel() {
		return _accessRequestFacilityServiceRemoteModel;
	}

	public void setAccessRequestFacilityServiceRemoteModel(
		BaseModel<?> accessRequestFacilityServiceRemoteModel) {
		_accessRequestFacilityServiceRemoteModel = accessRequestFacilityServiceRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			AccessRequestFacilityServiceLocalServiceUtil.addAccessRequestFacilityService(this);
		}
		else {
			AccessRequestFacilityServiceLocalServiceUtil.updateAccessRequestFacilityService(this);
		}
	}

	@Override
	public AccessRequestFacilityService toEscapedModel() {
		return (AccessRequestFacilityService)Proxy.newProxyInstance(AccessRequestFacilityService.class.getClassLoader(),
			new Class[] { AccessRequestFacilityService.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		AccessRequestFacilityServiceClp clone = new AccessRequestFacilityServiceClp();
	...
	public boolean equals(Object obj) {
		...
		AccessRequestFacilityServiceClp accessRequestFacilityService = null;

		try {
			accessRequestFacilityService = (AccessRequestFacilityServiceClp)obj;
		}
	...
	private BaseModel<?> _accessRequestFacilityServiceRemoteModel;
}