...
import com.pacnet.connect.service.SMA_reservationLocalServiceUtil;
 ...
 * @author CloudSmartz
 */
public class SMA_reservationClp extends BaseModelImpl<SMA_reservation>
	implements SMA_reservation {
	public SMA_reservationClp() {
	}
	...
	public BaseModel<?> getSMA_reservationRemoteModel() {
		return _sma_reservationRemoteModel;
	}

	public void setSMA_reservationRemoteModel(
		BaseModel<?> sma_reservationRemoteModel) {
		_sma_reservationRemoteModel = sma_reservationRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			SMA_reservationLocalServiceUtil.addSMA_reservation(this);
		}
		else {
			SMA_reservationLocalServiceUtil.updateSMA_reservation(this);
		}
	}

	@Override
	public SMA_reservation toEscapedModel() {
		return (SMA_reservation)Proxy.newProxyInstance(SMA_reservation.class.getClassLoader(),
			new Class[] { SMA_reservation.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		SMA_reservationClp clone = new SMA_reservationClp();
	...
	public int compareTo(SMA_reservation sma_reservation) {
		long primaryKey = sma_reservation.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		SMA_reservationClp sma_reservation = null;

		try {
			sma_reservation = (SMA_reservationClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.pacnet.connect.model.SMA_reservation");
	...
	private BaseModel<?> _sma_reservationRemoteModel;
}