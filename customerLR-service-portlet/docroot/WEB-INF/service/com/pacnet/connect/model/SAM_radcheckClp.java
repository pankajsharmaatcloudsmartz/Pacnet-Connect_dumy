...
import com.pacnet.connect.service.SAM_radcheckLocalServiceUtil;
 ...
 * @author CloudSmartz
 */
public class SAM_radcheckClp extends BaseModelImpl<SAM_radcheck>
	implements SAM_radcheck {
	public SAM_radcheckClp() {
	}
	...
	public BaseModel<?> getSAM_radcheckRemoteModel() {
		return _sam_radcheckRemoteModel;
	}

	public void setSAM_radcheckRemoteModel(BaseModel<?> sam_radcheckRemoteModel) {
		_sam_radcheckRemoteModel = sam_radcheckRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			SAM_radcheckLocalServiceUtil.addSAM_radcheck(this);
		}
		else {
			SAM_radcheckLocalServiceUtil.updateSAM_radcheck(this);
		}
	}

	@Override
	public SAM_radcheck toEscapedModel() {
		return (SAM_radcheck)Proxy.newProxyInstance(SAM_radcheck.class.getClassLoader(),
			new Class[] { SAM_radcheck.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		SAM_radcheckClp clone = new SAM_radcheckClp();
	...
	public int compareTo(SAM_radcheck sam_radcheck) {
		long primaryKey = sam_radcheck.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		SAM_radcheckClp sam_radcheck = null;

		try {
			sam_radcheck = (SAM_radcheckClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.pacnet.connect.model.SAM_radcheck");
	...
	private BaseModel<?> _sam_radcheckRemoteModel;
}