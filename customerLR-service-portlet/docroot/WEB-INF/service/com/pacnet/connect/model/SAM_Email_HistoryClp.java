...
import com.pacnet.connect.service.SAM_Email_HistoryLocalServiceUtil;
 ...
 * @author CloudSmartz
 */
public class SAM_Email_HistoryClp extends BaseModelImpl<SAM_Email_History>
	implements SAM_Email_History {
	public SAM_Email_HistoryClp() {
	}
	...
	public BaseModel<?> getSAM_Email_HistoryRemoteModel() {
		return _sam_Email_HistoryRemoteModel;
	}

	public void setSAM_Email_HistoryRemoteModel(
		BaseModel<?> sam_Email_HistoryRemoteModel) {
		_sam_Email_HistoryRemoteModel = sam_Email_HistoryRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			SAM_Email_HistoryLocalServiceUtil.addSAM_Email_History(this);
		}
		else {
			SAM_Email_HistoryLocalServiceUtil.updateSAM_Email_History(this);
		}
	}

	@Override
	public SAM_Email_History toEscapedModel() {
		return (SAM_Email_History)Proxy.newProxyInstance(SAM_Email_History.class.getClassLoader(),
			new Class[] { SAM_Email_History.class },
			new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		SAM_Email_HistoryClp clone = new SAM_Email_HistoryClp();
	...
	public int compareTo(SAM_Email_History sam_Email_History) {
		long primaryKey = sam_Email_History.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		SAM_Email_HistoryClp sam_Email_History = null;

		try {
			sam_Email_History = (SAM_Email_HistoryClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.pacnet.connect.model.SAM_Email_History");
	...
	private BaseModel<?> _sam_Email_HistoryRemoteModel;
}