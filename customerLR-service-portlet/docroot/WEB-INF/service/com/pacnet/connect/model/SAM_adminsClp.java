...
import com.pacnet.connect.service.SAM_adminsLocalServiceUtil;
 ...
 * @author CloudSmartz
 */
public class SAM_adminsClp extends BaseModelImpl<SAM_admins>
	implements SAM_admins {
	public SAM_adminsClp() {
	}
	...
	public BaseModel<?> getSAM_adminsRemoteModel() {
		return _sam_adminsRemoteModel;
	}

	public void setSAM_adminsRemoteModel(BaseModel<?> sam_adminsRemoteModel) {
		_sam_adminsRemoteModel = sam_adminsRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			SAM_adminsLocalServiceUtil.addSAM_admins(this);
		}
		else {
			SAM_adminsLocalServiceUtil.updateSAM_admins(this);
		}
	}

	@Override
	public SAM_admins toEscapedModel() {
		return (SAM_admins)Proxy.newProxyInstance(SAM_admins.class.getClassLoader(),
			new Class[] { SAM_admins.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		SAM_adminsClp clone = new SAM_adminsClp();
	...
	public int compareTo(SAM_admins sam_admins) {
		long primaryKey = sam_admins.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		SAM_adminsClp sam_admins = null;

		try {
			sam_admins = (SAM_adminsClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.pacnet.connect.model.SAM_admins");
	...
	private BaseModel<?> _sam_adminsRemoteModel;
}