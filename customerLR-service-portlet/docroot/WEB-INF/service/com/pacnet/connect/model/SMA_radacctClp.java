...
import com.pacnet.connect.service.SMA_radacctLocalServiceUtil;
 ...
 * @author CloudSmartz
 */
public class SMA_radacctClp extends BaseModelImpl<SMA_radacct>
	implements SMA_radacct {
	public SMA_radacctClp() {
	}
	...
	public BaseModel<?> getSMA_radacctRemoteModel() {
		return _sma_radacctRemoteModel;
	}

	public void setSMA_radacctRemoteModel(BaseModel<?> sma_radacctRemoteModel) {
		_sma_radacctRemoteModel = sma_radacctRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			SMA_radacctLocalServiceUtil.addSMA_radacct(this);
		}
		else {
			SMA_radacctLocalServiceUtil.updateSMA_radacct(this);
		}
	}

	@Override
	public SMA_radacct toEscapedModel() {
		return (SMA_radacct)Proxy.newProxyInstance(SMA_radacct.class.getClassLoader(),
			new Class[] { SMA_radacct.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		SMA_radacctClp clone = new SMA_radacctClp();
	...
	public int compareTo(SMA_radacct sma_radacct) {
		long primaryKey = sma_radacct.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		SMA_radacctClp sma_radacct = null;

		try {
			sma_radacct = (SMA_radacctClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.pacnet.connect.model.SMA_radacct");
	...
	private BaseModel<?> _sma_radacctRemoteModel;
}