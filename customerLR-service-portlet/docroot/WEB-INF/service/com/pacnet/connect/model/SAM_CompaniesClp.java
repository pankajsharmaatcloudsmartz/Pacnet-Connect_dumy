...
import com.pacnet.connect.service.SAM_CompaniesLocalServiceUtil;
 ...
 * @author CloudSmartz
 */
public class SAM_CompaniesClp extends BaseModelImpl<SAM_Companies>
	implements SAM_Companies {
	public SAM_CompaniesClp() {
	}
	...
	public BaseModel<?> getSAM_CompaniesRemoteModel() {
		return _sam_CompaniesRemoteModel;
	}

	public void setSAM_CompaniesRemoteModel(
		BaseModel<?> sam_CompaniesRemoteModel) {
		_sam_CompaniesRemoteModel = sam_CompaniesRemoteModel;
	}

	public void persist() throws SystemException {
		if (this.isNew()) {
			SAM_CompaniesLocalServiceUtil.addSAM_Companies(this);
		}
		else {
			SAM_CompaniesLocalServiceUtil.updateSAM_Companies(this);
		}
	}

	@Override
	public SAM_Companies toEscapedModel() {
		return (SAM_Companies)Proxy.newProxyInstance(SAM_Companies.class.getClassLoader(),
			new Class[] { SAM_Companies.class }, new AutoEscapeBeanHandler(this));
	}

	@Override
	public Object clone() {
		SAM_CompaniesClp clone = new SAM_CompaniesClp();
	...
	public int compareTo(SAM_Companies sam_Companies) {
		long primaryKey = sam_Companies.getPrimaryKey();
	...
	public boolean equals(Object obj) {
		...
		SAM_CompaniesClp sam_Companies = null;

		try {
			sam_Companies = (SAM_CompaniesClp)obj;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.pacnet.connect.model.SAM_Companies");
	...
	private BaseModel<?> _sam_CompaniesRemoteModel;
}